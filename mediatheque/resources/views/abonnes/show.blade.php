@extends('layouts.user.userShow', ['action'=>"editAbonne", 'title'=>"Détails abonné", 'utilisateur'=>$abonne->utilisateur, 'model'=>$abonne])
...
@section('abonne')
        ...
        <label>
                ...
                <span class="label_show_value">{{  $abonne->type_de_carte == 0 ? "Scolaire" : "Identité"  }}</span>
        </label>
@endsection

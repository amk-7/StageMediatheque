...
@section('content')
    ...
    <main class="flex flex-col justify-center items-center m-auto">
        <form action="{{ $action }}" method="post" enctype="multipart/form-data" class="bg-white p-12 mb-12 max-w-4xl">
            ...
            <fieldset class="border border-solid border-gray-600 p-4 rounded-md space-y-3">
                <legend>Ouvrage</legend>
                <div class="flex flex-col m-3">
                    <label for="titre" class="label">Titre</label>
                    <input type="text" name="titre" id="titre" value="{{ $ouvrage->titre ?? old('titre') }}"
                    ...
                    <div class="flex flex-col w-2/3 space-y-3">
                        <div class="flex space-x-3 w-full">
                            <div class="flex flex-col w-1/2">
                                ...
                                <select name="niveau" class="select_btn @error('niveau') is-invalid @enderror">

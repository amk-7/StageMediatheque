...
A ce jour le projet n'est pas totalement terminé. Donc il est tout à fais logique de dire
que nous allons déjà terminer notre application avant de commencer à l'améliorer.
Comme amélioration, nous prévoyons d'optimiser notre code pour que les pages se charges
plus rapidement, implémenter une barre de recherche aux niveau de la liste des emprunts
afin de facilité la restitution des ouvrages pour chaque abonne, il nous faudra ajouter
aussi des filtres au niveau de la liste des abonnées pour permettre la recherche d'un
abonné et enfin gérer l'abonnement via flooz et T-money.

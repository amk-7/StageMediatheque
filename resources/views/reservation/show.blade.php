            ...
            <table border="1" id="liste_restitution" class="fieldset_border" >
                ...
                @foreach($emprunt->lignesEmprunts as $empruntOuvrage)
                    <tr class="fieldset_border" >
                        ...
                        <td class="fieldset_border" > {{ $empruntOuvrage->ouvragesPhysique->cote }} </td>
                        <td class="fieldset_border" > {{ $empruntOuvrage->ouvragesPhysique->ouvrage->titre }} </td>
                        <td class="fieldset_border" > {{ \App\Helpers\OuvragesPhysiqueHelper::afficherEtat($empruntOuvrage->etat_sortie) }} </td>
                    </tr>
                @endforeach
                </tbody>
            </table>

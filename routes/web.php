...
Route::group(['middleware' => ['role:abonne|bibliothecaire|responsable', 'auth']], function () {
    Route::get('/ouvrages/readPdf/{ouvrage}', [OuvrageController::class, 'readPdf'])->name('ouvrages.readPdf');
});
...
Route::group(['middleware' => ['role:bibliothecaire|responsable', 'auth']], function () {
    ...
    Route::get('abonnes/{abonne}/edit', [AbonneController::class, 'edit'])->name('abonnes.edit');
    Route::get('abonnes/{abonne}/show', [AbonneController::class, 'show'])->name('abonnes.show');
    Route::put('abonnes/{abonne}/', [AbonneController::class, 'update'])->name('abonnes.update');
    Route::delete('abonnes/{abonne}', [AbonneController::class, 'destroy'])->name('abonnes.destroy');
    ...
    Route::delete('suppression_liquide/{liquide}/', 'App\Http\Controllers\LiquideController@destroy')->name('liquides.destroy.one');
    Route::delete('suppression_des_liquides', 'App\Http\Controllers\LiquideController@delete_all')->name('liquides.destroy');
    ...
    Route::get('exporter_ouvrages', [OuvrageController::class, 'exportExcel'])->name('exporter_ouvrages');
...
Route::group(['middleware' => ['role:responsable', 'auth']], function () {
    ...
    Route::put('enregistrement_import_excel_new', [OuvrageController::class, 'importExcel'])->name('enregistrementImportExcelNew');

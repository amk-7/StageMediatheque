...
@section("content")
    <main>
        ...
        <div class="image_livre">
            <img src="{{ asset('storage/images/images_livre/'.$livrePapier->ouvragePhysique->ouvrage->image) }}" alt="{{$livrePapier->ouvragePhysique->ouvrage->image}}"
        </div>
        <div class="informations_livre">
            ...
            <label>Mots clè : {{ \App\Helpers\LivrePapierHelper::showArray($livrePapier->ouvragePhysique->ouvrage->mot_cle, "mot_cle_") }} </label><br>

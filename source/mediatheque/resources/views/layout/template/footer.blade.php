        ...
        <div class="grid grid-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          ">
                ...
                <p class="flex items-center justify-center md:justify-start mb-4">
                    ...
                    Rüdesheimer Straße 15, 80686 Munich, Allemagne
                </p>
                <p class="flex items-center justify-center md:justify-start mb-4">
                    ...
                    <a href="https://urbis-foundation.de/fr/accueil.html">info@urbis-foundation.de</a>
                </p>
                <p class="flex items-center justify-center md:justify-start mb-4">
            ...
            <div class="">
                ...
                <p class="mb-4">
                    <a href="https://ifnti.com/" class="text-gray-600">IFNTI</a>
                </p>
                <p class="mb-4">
                    <a href="#!" class="text-gray-600">DRE-RC</a>
                </p>
                <p class="mb-4">
                    <a href="#!" class="text-gray-600">Direction de la Culture</a>
                </p>
                <p>
                    <a href="#!" class="text-gray-600">Inspections de l'enseiement technique</a>
                </p>
                <p>
                    <a href="#!" class="text-gray-600">CLAC</a>
                </p>
            </div>
            <div class="">
                <h6 class="uppercase font-semibold mb-4 flex justify-center md:justify-start">
                ...
                <p class="flex items-center justify-center md:justify-start mb-4">
                    ...
                    <a href="info@urbistogo.org">info@urbistogo.org</a>
                </p>
                <p class="flex items-center justify-center md:justify-start mb-4">
                    <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="envelope"
                         class="w-4 mr-4" role="img" xmlns="http://www.w3.org/2000/svg"
                    ...
                    <a href="memem@urbistogo.org">memem@urbistogo.org</a>
                </p>
                <p class="flex items-center justify-center md:justify-start mb-4">
                    <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="phone"
                         class="w-4 mr-4" role="img" xmlns="http://www.w3.org/2000/svg"

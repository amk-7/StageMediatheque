        ...
        <fieldset>
            ...
            <div>
                ...
                <input type="text" name="nom" id="nom" value="{{old('nom')}}"
                       class="input @error('nom') is-invalid @enderror">
                @error('nom')
            ...
            <div>
                ...
                <input type="text" id="prenom" value="{{old('prenom')}}" name="prenom"
                       class="input @error('prenom') is-invalid @enderror">
                @error('prenom')
                <div class="alert">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div>
                ...
                <input type="text" id="nom_utilisateur" value="{{old('nom_utilisateur')}}" name="nom_utilisateur"
                       class="input @error('nom_utilisateur') is-invalid @enderror">
            ...
            <div>
                ...
                <input type="text" id="numero_maison" value="{{old('numero_maison')}}" name="numero_maison"
                       class="input @error('numero_maison') is-invalid @enderror">
                @error('numero_maison')
                <div class="alert">{{ $message }}</div>
                @enderror
                ...
                <div>
                    ...
                    <input type="tel" id="contact" value="{{old('contact')}}" name="contact"
                ...
                <div>
                    ...
                    <div>
                        ...
                        <input type="text" id="ville" value="{{old('ville')}}" name="ville"
                               class="input @error('ville') is-invalid @enderror">
                        @error('ville')
                        <div class="alert">{{ $message }}</div>
                        @enderror

                        <label class="label" for="quartier">Quartier</label>
                        <input type="text" id="quartier" value="{{old('quartier')}}" name="quartier"
                               class="input @error('quartier') is-invalid @enderror">
                        @error('quartier')
                        <div class="alert">{{ $message }}</div>
                        @enderror
                    </div>

    ...
    >
        <nav x-show="currentSidebarTab == 'linksTab'" aria-label="Main" class="flex flex-col h-full">
            ...
            <div class="flex-1 px-4 space-y-2 overflow-hidden hover:overflow-auto">
               <ul>
                   <li>
                       <a href="/liste_livres_papier" class="flex items-center w-full space-x-2 text-white bg-indigo-600 rounded-lg">
                  <span aria-hidden="true" class="p-2 bg-indigo-700 rounded-lg">
                   ...
                   @if(in_array(Auth::user()->roles()->first()->name, ["responsable", "bibliothecaire"], true))
                       <li>
                           <label class="flex items-center p-2 w-full text-base font-normal text-indigo-600" aria-controls="dropdown-example">
                           ...
                           <ul id="dropdown-example" class="ml-12">
                               ...
                               <li>
                                   <a href="/liste_des_emprunts" class="flex items-center p-2 w-full text-base font-normal rounded-lg transition duration-75 group hover:text-white text-indigo-600 hover:bg-indigo-600">Emprunt</a>
                               </li>
                               <li>
                                   <a href="/liste_des_restitutions" class="flex items-center p-2 w-full text-base font-normal rounded-lg transition duration-75 group hover:text-white text-indigo-600 hover:bg-indigo-600">Réstitution</a>
                               </li>
                           </ul>
                       </li>
                       <li>
                           ...
                           <ul id="dropdown-example" class="ml-12">
                               <li>
                                   <a href="/liste_des_abonnes" class="flex items-center p-2 w-full text-base font-normal rounded-lg transition duration-75 group hover:text-white text-indigo-600 hover:bg-indigo-600">Abonnés</a>
                               </li>
                               @if(Auth::user()->roles()->first()->name == "responsable")
                                   <li>
                                       <a href="/liste_des_personnels" class="flex items-center p-2 w-full text-base font-normal rounded-lg transition duration-75 group hover:text-white text-indigo-600 hover:bg-indigo-600">Presonnels</a>
                                   </li>
                           </ul>
                       </li>
                       <li>
                           ...
                           <ul id="dropdown-example" class="ml-12">
                               <li>
                                   <a href="/formulaire_import_excel" class="flex items-center p-2 w-full text-base font-normal rounded-lg transition duration-75 group hover:text-white text-indigo-600 hover:bg-indigo-600">Livres papier</a>
                               </li>
                           </ul>
                       </li>
                      @endif
                   ...
                   @if (Auth::user()->roles()->first()->name == "abonne")
                       <li>
                           <ul id="dropdown-example" class="">
                               <li>
                                   <a href="/" class="flex items-center p-2 w-full text-base font-normal rounded-lg transition duration-75 group hover:text-white text-indigo-600 hover:bg-indigo-600">Mon compte</a>
                               </li>
                           </ul>
                           <ul id="dropdown-example" class="">
                               <li>
                                   <a href="/" class="flex items-center p-2 w-full text-base font-normal rounded-lg transition duration-75 group hover:text-white text-indigo-600 hover:bg-indigo-600">Mes emprunts</a>
                               </li>
                           </ul>
                           <ul id="dropdown-example" class="">
                               <li>
                                   <a href="/" class="flex items-center p-2 w-full text-base font-normal rounded-lg transition duration-75 group hover:text-white text-indigo-600 hover:bg-indigo-600">Emprunts en cours</a>
                               </li>
                           </ul>
                       </li>
                   @endif

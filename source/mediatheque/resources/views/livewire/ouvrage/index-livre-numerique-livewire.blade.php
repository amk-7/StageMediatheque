                ...
                @foreach($livresNumeriques as $livresNumerique)
                    <div>
                        <a href="{{route('affichageLivreNumerique', $livresNumerique)}}" class="">
                            <div class="">
                                <img src="{{ asset('storage/images/images_livre/'.$livresNumerique->ouvragesElectronique->ouvrage->image) }}"
                                     alt="{{$livresNumerique->ouvragesElectronique->ouvrage->image}}" class="border border-solid"/>
                            </div>
                            <div class="text-center">
                                <label>
                                    <span>{{ strtolower($livresNumerique->ouvragesElectronique->ouvrage->titre) }}</span>
                                </label>
                            </div>
                        </a>
                    </div>

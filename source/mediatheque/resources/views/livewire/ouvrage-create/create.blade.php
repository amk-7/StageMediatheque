<fieldset>
    ...
    <div>
        <div>
            <label>Titre</label>
            <input wire:model="titre" type="text" name="titre" value="Titre test" placeholder="saisir le titre du livre" class="@error('titre') is-invalid @enderror">
            @error('titre')
        ...
        <div>
            ...
            <select wire:model="selected_annee" wire:change="validateOuvrage" name="annee_apparution" class="@error('annee_apparution') is-invalid @enderror">

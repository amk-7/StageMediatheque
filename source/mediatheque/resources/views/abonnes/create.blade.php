...
@section('abonne')
    ...
    <div>
        <label class="label" for="niveau_etude">Niveau d'étude : </label>
            <div>
                <input type="radio" name="niveau_etude" value="Primaire">Primaire</input>
                <input type="radio" name="niveau_etude" value="Collège">Collège</input>
                <input type="radio" name="niveau_etude" value="Lycée">Lycée</input>
                <input type="radio" name="niveau_etude" value="Université">Université</input>
            </div>
    </div>
    ...
    <div>
        <label class="label" for="type_de_carte">Type de carte :</label>
            <div>
                <input type="radio" name="type_de_carte" value="Identité">Identité</input>
                <input type="radio" name="type_de_carte" value="Scolaire">Scolaire</input>
            </div>
    </div>
